...
async def load_book_documents():
    """Load all book markdown files from data/documents and process them into the RAG system"""
    ...
    print("\n💡 To process these documents into the RAG system, run: python load_documents_to_rag.py")
